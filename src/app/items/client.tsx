...
import { type ItemForCard, MediaCard } from "@/components/media/media-card";
...
import { getNew, type NullablePartial } from "@/lib/utils/types";
	...
	return (
		<>
			...
			<SearchHeader
				...
				onSearchChange={(term) =>
					setSearchOption({ ...searchOption, search: term })
				}
			...
			<ContentArea
				...
				emptyMessage={
					searchOption.search
						? `没有找到匹配"${searchOption.search}"的电影`
						: "没有找到电影"
				}
				skeletonType="grid"
				skeletonCount={10}
