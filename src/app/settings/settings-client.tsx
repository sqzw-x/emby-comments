...
import type { EmbyServer, ExternalLinkProvider } from "@prisma/client";
...
export default function SettingsClient({
	...
	const [providers, setProviders] =
		useState<ExternalLinkProvider[]>(initialProviders);
	...
	return (
		<Stack spacing={4}>
			...
			{/* Emby 服务器设置 */}
			{activeTab === 0 && (
				<EmbyServerSetting servers={servers} onServersChange={fetchServers} />
			)}
			{/* 外部链接设置 */}
			{activeTab === 1 && (
				<ExternalLinkSetting
