...
export const buildSearchParams = (searchParams?: Record<string, string | string[] | undefined>) => {
...
type GetParams<T extends PageProps | null> = T extends { params: Promise<Record<string, string | string[]>> }
  ? Awaited<T["params"]>
  : null;
...
type PathBuilder<T extends PageProps | null, P = GetParams<T>, SP = GetSearchParams<T>> = T extends null
  ? () => string
  : P extends null
